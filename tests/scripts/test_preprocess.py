import pandas as pd
import pytest
from scripts.preprocess import preprocess, validate_required_columns, drop_missing_locations, fill_missing_passenger_count, remove_invalid_coordinates, remove_invalid_trip_durations, remove_duration_outliers, parse_datetime, extract_time_features, remove_duplicates
...
data = {
    ...
    'pickup_datetime': ['2025-12-20 12:00:00', '2025-12-20 13:00:00', 'invalid', '2025-12-20 14:00:00', '2025-12-20 12:00:00'],
    'dropoff_datetime': ['2025-12-20 12:30:00', '2025-12-20 13:45:00', '2025-12-20 14:00:00', '2025-12-20 14:30:00', '2025-12-20 12:30:00'],
...
def test_validate_required_columns():
    validate_required_columns(df)  # should pass without error
